...
def whileloop_go_over_list2(myLis):
    i = 0
    while i < len(myLis):
        toPrint = myLis[i] * 2
        print(toPrint)
...
if __name__ ==  '__main__': 
    ...
    inputString = "hello " 
    intputInt = 1
    printstr(inputString, intputInt)
    print("****Question 5****")
    inputForAddFunction1 = 2
    inputForAddFunction2 = 3
    resultVariable = funcvars(inputForAddFunction1, inputForAddFunction2)
    print(resultVariable)
    print("****Question 6****")
    list1 = ["startList", 1,3,4,5,6, "endList"]
    list2 = [1,2,3,4,5,6,7,8,9]
    go_over_list(list1)
    go_over_list1()
    go_over_list2(list2)
    resultVariable = go_over_list3(list2)
    go_over_list(resultVariable)
    print("****Question 7****")
    whileloop_go_over_list(list1)
    whileloop_go_over_list1()
    whileloop_go_over_list2(list2)
    resultVariable = whileloop_go_over_list3(list2)
    whileloop_go_over_list(resultVariable)
...
#Your answer here: It is easy to learn python, I feel like I can just write it 
#and I feel like it was designed to be easy to read and write.
...
#Your answer here: reading the documentation, learning the syntax are good steps to start
